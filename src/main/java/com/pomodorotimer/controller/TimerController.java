...
public class TimerController {
    ...
    Integer minutes = TimerServiceImpl.getMinutes();
    Integer seconds = TimerServiceImpl.getSeconds();
    ...
    public void timerScreen() {
        ...
        TimerServiceImpl.setTimeLabel(timeLabel);
        
        panel.add(TimerServiceImpl.getTimeLabel(), BorderLayout.CENTER);
        ...
        ActionListener taskListener = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                TimerServiceImpl.setMinutes(minutes);
                TimerServiceImpl.setSeconds(seconds);
